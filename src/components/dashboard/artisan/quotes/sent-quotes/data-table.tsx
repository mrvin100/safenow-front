...
import { getArtisanQuotes } from '@src/actions/quotes.actions';
import { TableLoader } from '@src/components/dashboard/table-loader';
import { EmptyContent } from '@src/components/empty-content';
import { flexRender, getCoreRowModel, useReactTable } from '@tanstack/react-table';
import { useMemo, useState } from 'react';
import { quotesTableColumns } from './colums';
...
export const QuotesTable = () => {
	...
	const { isLoading, data: response } = useServerActionQuery(getArtisanQuotes, {
		input: { page },
		queryKey: ['get-artisan-sent-quotes', page],
	});
	...
	return (
		<div className='bg-card border rounded-xl p-5 space-y-5'>
			<div className='flex justify-between items-center'>
				<h2 className='text-lg font-medium text-foreground'>Liste de devis envoyé</h2>
			</div>
